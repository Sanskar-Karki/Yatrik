...
import Props from "./Props"; // Updated import
import styles from "../Treaking/Treaking.module.css"; // Import module CSS
import { Link } from "react-router-dom";
import Trekkingdst from "./Trekking.jpg";
  ...
  return (
    <>
      ...
      <div className={styles.property1}>
        <h1 className={styles.propertyTitle}>Trending Mountaineering</h1>
